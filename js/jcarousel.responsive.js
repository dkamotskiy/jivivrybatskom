...
(function($) {
    $(function() {
        var jcarousel = $('#vproekte-main-block .col-md-8 .jcarousel');
        ...
        $('#vproekte-main-block .col-md-8 .jcarousel-control-prev')
            .jcarouselControl({
                target: '-=1'
            });

        $('#vproekte-main-block .col-md-8 .jcarousel-control-next')
            .jcarouselControl({
                target: '+=1'
            });
